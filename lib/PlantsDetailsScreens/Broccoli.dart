...
class _BroccoliState extends State<Broccoli> {
  ...
  final String careInstructions =
      ...
      "• Transplant seedlings to well-drained soil with full sun.\n"
      "• Space plants 45-60 cm apart.\n"
      "• Fertilize with balanced nutrients; avoid excess nitrogen to prevent soft heads.\n"
      "• Remove yellowing leaves to maintain plant health.";

  final String idealEnvironment =
      "• Climate: Cool-season crop; prefers moderate temperatures.\n"
      "• Soil: Fertile, well-drained loamy soil with pH 6.0–7.0.\n"
      "• Temperature: Ideal growth between 18°C and 24°C.\n"
      "• Light: Full sunlight, at least 6 hours daily.";

  final String wateringTips =
      "• Water consistently: Keep soil moist but not soggy.\n"
      "• Frequency: 2–3 times per week depending on weather.\n"
      "• Mulch around plants to conserve moisture and control weeds.";

  final String sicknessInfo =
      "• Common Issues: Aphids, cabbage worms, downy mildew, and black rot.\n"
      "• Prevention: Rotate crops; maintain spacing for airflow.\n"
      "• Treatment: Apply neem oil or organic insecticidal sprays.\n"
      "• Tip: Harvest heads promptly to prevent flowering and loss of quality.";
